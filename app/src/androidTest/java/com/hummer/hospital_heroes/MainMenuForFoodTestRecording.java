...
public class MainMenuForFoodTestRecording {
    ...
    public void mainMenuForFoodTestRecording() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textView2), withText("Collect the food!"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                1),
                        isDisplayed()));
        textView.check(matches(withText("Collect the food!")));
